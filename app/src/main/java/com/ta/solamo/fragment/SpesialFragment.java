 ...
 */
public class SpesialFragment extends Fragment implements BottomSheetDialogMenuDetail.BottomSheetListenerDetail{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_spesial, container, false);

        rvMenu = v.findViewById(R.id.rv_spesial);
    ...
    public void initAdapter(){
        ...
        Query query = expressb.whereEqualTo("menu_category","spesial");
