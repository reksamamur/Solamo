 ...
 */
public class SnackFragment extends Fragment implements BottomSheetDialogMenuDetail.BottomSheetListenerDetail{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMenu = v.findViewById(R.id.rv_snack);
    ...
    public void initAdapter(){
        ...
        Query query = expressb.whereEqualTo("menu_category","snack");
