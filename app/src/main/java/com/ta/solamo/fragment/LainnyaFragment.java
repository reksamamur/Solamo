 ...
 */
public class LainnyaFragment extends Fragment implements BottomSheetDialogMenuDetail.BottomSheetListenerDetail{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMenu = v.findViewById(R.id.rv_lainnya);
    ...
    public void initAdapter(){
        ...
        Query query = expressb.whereEqualTo("menu_category","lain");
