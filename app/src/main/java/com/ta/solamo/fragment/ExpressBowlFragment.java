 ...
 */
public class ExpressBowlFragment extends Fragment implements BottomSheetDialogMenuDetail.BottomSheetListenerDetail{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_express_bowl, container, false);
        rvMenu = v.findViewById(R.id.rv_expressBowl);
    ...
    public void initAdapter(){
        ...
        Query query = expressb.whereEqualTo("menu_category","express_bowl");
